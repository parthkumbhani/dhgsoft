  ...
  <svg
    ...
    <g transform="translate(0.15352384)">
      <g transform="matrix(0.36351711,0,0,0.36351711,4.6672789,23.638451)">
        ...
        />
        <polygon
          points="67.7,53.4 41.1,67.3 14.5,53.4 0,60.8 41.1,82.3 82.2,60.8"
          fill="#ff5224"
          transform="translate(0,-36)"
        />
        <polygon
          points="41.1,11 82.2,32.2 41.1,53.7 0,32.2"
          fill="#ff5224"
          transform="translate(0,-36)"
        />
      </g>
      <g transform="matrix(0.14782641,0,0,0.14782641,24.250,28.736084)">
        <g transform="translate(0,-36)">
          ...
          />
          <path
            d="m 203.2,79 c 0,0 -4.9,10.1 -21.1,10.1 -11.4,0 -19.1,-6.7 -19.1,-16 0,-10.3 9.7,-15.6 25.2,-15.6 h 14 v -4.6 c 0,-9.5 -5.4,-13.5 -15.5,-13.5 -9.6,0 -14.4,4.6 -14.4,10.8 v 1.2 h -8.2 v -2.7 c 0,-8 7.1,-16.4 22.8,-16.4 14.9,0 24.1,6.6 24.1,21.1 v 27.7 h 6.6 v 7.3 h -13.3 l -1.1,-9.2 v 0 z m -1,-15.1 h -13.4 c -9.7,0 -17,2.8 -17,9.2 0,5.4 5.1,9 12.2,9 12.8,0 18.2,-9.6 18.2,-9.6 z"
            fill="#1E293B"
          />
          <path
            d="M 236.2,18.2 V 33 h 17.5 v 7.1 h -17.5 v 29.8 c 0,7.8 3.4,11.6 9.2,11.6 6.2,0 9.9,-1.8 9.9,-1.8 v 7.5 c 0,0 -4.5,1.9 -11.4,1.9 -10.6,0 -16.7,-6.2 -16.7,-18.7 V 40.1 h -8.4 V 33 h 8.4 l 1.5,-14.8 z"
            fill="#1E293B"
          />
          <path
            d="m 300.5,79 c 0,0 -4.9,10.1 -21.1,10.1 -11.4,0 -19.1,-6.7 -19.1,-16 0,-10.3 9.7,-15.6 25.2,-15.6 h 14 v -4.6 c 0,-9.5 -5.4,-13.5 -15.5,-13.5 -9.6,0 -14.4,4.6 -14.4,10.8 v 1.2 h -8.2 v -2.7 c 0,-8 7.1,-16.4 22.8,-16.4 14.9,0 24.1,6.6 24.1,21.1 v 27.7 h 6.6 v 7.3 h -13.3 l -1.1,-9.2 v 0 z m -0.9,-15.1 h -13.4 c -9.7,0 -17,2.8 -17,9.2 0,5.4 5.1,9 12.2,9 12.8,0 18.2,-9.6 18.2,-9.6 z"
            fill="#1E293B"
          />
          <path
            d="m 331.4,80 -1.4,8.3 h -6.7 v -81 h -8.2 V 0 h 17 v 35.7 c 0,0.5 -0.4,4 -0.4,4 h 0.4 c 0,0 5,-7.6 18.5,-7.6 13.7,0 25.6,10.2 25.6,28.4 0,18.7 -11,28.5 -25.4,28.5 -13.4,0 -18.9,-9.1 -18.9,-9.1 h -0.5 z m 0.7,-32.4 v 24.8 c 3,6 9.8,9.2 16.6,9.2 9.8,0 18.6,-6.7 18.6,-21.1 0,-14.4 -9.6,-20.9 -18.5,-20.9 -10.2,0 -15,5.5 -16.7,8 z"
            fill="#1E293B"
          />
          <path
            d="m 419.4,41.2 c -1.3,-0.5 -3.4,-0.8 -6.3,-0.8 -13.7,0 -16.6,16.3 -16.6,16.3 V 81 h 9 v 7.3 h -26 V 81 h 8.2 V 40.4 h -8.2 V 33 h 14.9 l 0.8,14.1 h 0.4 c 0,0 2.7,-14.9 17.8,-14.9 2.5,0 4.6,0.4 6,0.6 z"
            fill="#1E293B"
          />
          <path
            d="m 444.5,80.9 h 7.9 v 7.3 h -25 v -7.3 h 8.2 V 40.4 h -8.2 V 33 h 17 V 80.9 Z M 439.6,23 c -3.8,0 -6.9,-3.1 -6.9,-7.1 0,-3.8 3.1,-6.9 6.9,-6.9 3.9,0 7.1,3.1 7.1,6.9 0,4 -3.2,7.1 -7.1,7.1 z"
            fill="#1E293B"
          />
          <path
            d="m 463.9,60.6 c 0,14.4 9.3,21.1 19.9,21.1 12.9,0 18.1,-6 18.1,-6 L 505,82 c 0,0 -6.2,7.1 -21.8,7.1 -16.4,0 -28,-10.2 -28,-28.5 0,-19.2 10.5,-28.4 27.5,-28.4 17.3,0 23.5,9.5 23.5,19.8 v 3 H 498 v -1.8 c 0,-8.3 -4.7,-13.5 -15.5,-13.5 -11.1,-0.1 -18.6,5.5 -18.6,20.9 z"
            fill="#1E293B"
          />
          <path
            d="m 526.7,56.1 h 13.7 l 13.3,-16 h -6.9 V 33 h 25 v 7.1 h -8.5 l -16.1,19.5 16.9,21.5 h 8.4 v 7.1 H 559.1 L 539.7,63 h -13 v 17.9 h 7.9 v 7.3 h -25.1 v -7.3 h 8.3 V 7.3 h -8.3 V 0 h 17.2 z"
            fill="#1E293B"
          />
          <path
            d="m 584.7,70.3 v 1.3 c 0,5.7 4.7,10.2 14.8,10.2 10.2,0 14.7,-3.3 14.7,-8.8 0,-5.7 -7.3,-7.6 -15.3,-9 -9.9,-1.8 -21.1,-4.4 -21.1,-16.3 0,-9.5 9,-15.5 21.3,-15.5 16.3,0 22.4,6.7 22.4,15.1 v 4 h -8.3 v -2.6 c 0,-5.9 -3.9,-9.3 -13.7,-9.3 -6.4,0 -12.9,2.6 -12.9,8.4 0,6.5 7.8,7.7 15.9,9.2 10.4,2 20.5,5.2 20.5,16.1 0,8.9 -6.6,16 -23.2,16 -17,0 -23.3,-7.6 -23.3,-15.4 v -3.4 z"
            fill="#1E293B"
          />
        </g>
      </g>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between h-full w-full relative z-10 pointer-events-none p-6 text-center">
        ...
        >
          <button
            className="flex items-center justify-center gap-1.5 text-[9.5px] font-extrabold text-[#C5165C] uppercase tracking-widest transition-colors select-none"
          >
