        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col items-start space-y-4">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <a href="https://www.youtube.com/@DHGsoft" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-900/50 border border-slate-850 text-slate-400 hover:text-white hover:bg-[#FF0000] hover:border-[#FF0000] transition-all duration-300 flex items-center justify-center">
