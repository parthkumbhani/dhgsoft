...
export default function Hero() {
  return (
    <Section variant="white" size="hero" containerSize="wide" className="pt-8 md:pt-12 pb-16">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative w-full">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-xl aspect-[4/5] bg-slate-50 border border-line">
              <Image
            ...
            <div className="card absolute -top-4 -left-4 lg:-left-8 bg-white border border-line rounded-2xl shadow-lg p-5 min-w-[140px] text-left">
            ...
            <div className="card absolute -bottom-4 -right-4 lg:-right-8 bg-brand text-white rounded-2xl shadow-lg p-5 min-w-[140px] text-left border border-brand-hot/20">
