          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Maximize power efficiency and uptime — with DCIM integration, AI-driven cooling setpoint optimization, and predictive power generator testing.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Data Centres</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Data centres face soaring demand and energy costs, where uptime and efficiency are mission-critical. Managing energy utilization, liquid cooling loops for GPU racks, and power grid stability are key operational priorities.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "AI cooling optimization and liquid cooling adoption",
                      "Dynamic PUE and WUE telemetry dashboards",
                      "Generator and UPS health prediction",
                      "Scope 2 carbon reporting for grid energy",
                      "DCIM and BMS central system integrations"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Sub-Station to Server Rack</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft partners with data centre operators to integrate DCIM, deploy AI-driven cooling optimization, and orchestrate power, cooling, and IT infrastructure holistically.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$500B</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global data centre market by 2030</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">40%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Energy reduction with AI cooling</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">Zero downtime</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Availability target</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">1.1 PUE</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Achievable through optimization</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["AI compute demand", "Sustainability mandates", "Grid constraints", "Cost pressure"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Uptime", "PUE optimization", "Water efficiency", "Scalability"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Data Centres Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">AI Compute Demand</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Massive and rapid capacity expansion required.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">PUE Pressure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Sub-1.2 PUE targets requiring optimization.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Grid Constraints</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Power availability limiting site expansion.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cooling Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Liquid cooling for high-density GPU workloads.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Water Scrutiny</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Water usage effectiveness under regulatory scrutiny.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Uptime Mandate</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
              ...
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Data centre operations expertise shortage.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                "tag": "AI",
                                "val": "40% energy cut",
                                "title": "AI Cooling Optimization",
                                "desc": "ML-driven cooling setpoint and airflow optimization.",
                                "img": "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Full telemetry",
                                "title": "Rack-level Monitoring",
                                "desc": "Sensor-driven rack, PDU, and CRAC visibility.",
                ...
                },
                {
                                ...
                                "val": "PUE minimized",
                                "title": "PUE Analytics",
                                "desc": "Real-time PUE and WUE optimization.",
                                "img": "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Twin",
                                "val": "Airflow modeled",
                                "title": "DC Digital Twin",
                                "desc": "CFD and thermal digital twin for capacity planning.",
                ...
                },
                {
                                ...
                                "desc": "UPS, generator, and CRAC prediction.",
                                "img": "https://images.unsplash.com/photo-1597733336794-12d05021d510?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Sustainability",
                                "val": "Green certified",
                                "title": "Sustainability Reporting",
                                "desc": "Carbon and water accounting.",
                ...
                },
                {
                                ...
                                "desc": "Demand response coordination with power grids.",
                                "img": "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Security",
                                "val": "Airtight BMS",
                                "title": "BMS/DCIM Security",
                                "desc": "Zoning BMS and physical security systems from risks.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Data Centres operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "PUE Optimization", val: "40% cooling cut", desc: "Energy reduction with AI cooling controls.", icon: TrendingUp },
                    { title: "Uptime Protection", val: "99.999% uptime", desc: "Predictive infrastructure health diagnostics.", icon: Clock },
                    { title: "Water Efficiency", val: "30% water saving", desc: "Closed-loop cooling flow optimization.", icon: Cpu },
                    { title: "AI Capacity Scaling", val: "2x capacity scale", desc: "Liquid cooling integration for GPU racks.", icon: Award },
                    { title: "Green Metrics", val: "Scope 2 ready", desc: "Live carbon and water reporting dashboards.", icon: Zap },
                    { title: "Cyber Resilience", val: "Secured BMS", desc: "Network isolation and incident tracking.", icon: ShieldAlert },
                    { title: "Grid Integration", val: "Grid stable", desc: "Load shaving during peak grid pricing.", icon: Database },
                    { title: "DCIM Integration", val: "Full control", desc: "Unified single pane of glass for multi-site operations.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Data Centres organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Data Centres Operations?</span>
            </h2>
