          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Monitor, optimize, and protect critical energy assets — with low-latency SCADA systems, predictive leak detection, and unified remote operations.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Oil & Gas</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Oil and gas operations span harsh, remote, and highly regulated assets. Protecting pipeline integrity, optimizing refining throughput, and ensuring worker safety at isolated sites require reliable telemetry, secure edge computing, and real-time SCADA integration.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Real-time pipeline leak detection algorithms",
                      "Unified remote operations control centers",
                      "SCADA network cybersecurity zoning",
                      "Asset health modeling for high-wear compressors",
                      "Scope 1 flare gas reduction tracking"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Isolated Assets to Integrated Intelligence</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft partners with upstream and downstream operators to secure legacy SCADA networks, deploy predictive maintenance for remote platforms, and integrate production with supply chain dispatch logistics.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$5.1T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global energy and fuel market value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in pipeline leak response times</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">20%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in unscheduled asset downtime</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">15%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Carbon footprint reduction via flare tracking</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Operational safety", "Asset isolation", "SCADA cybersecurity", "Pipeline integrity"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Compressor uptime", "Emission verification", "Edge telemetry", "Dispatch alignment"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Oil & Gas Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Pipeline Leak Risks</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Monitoring miles of remote pipelines to prevent environmental incidents.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Isolated Operations</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of reliable high-bandwidth connectivity to remote off-shore platforms.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">SCADA Vulnerability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Legacy SCADA systems exposed to modern enterprise security threats.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Equipment Wear</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Rotating equipment exposed to extreme conditions leading to wear.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Flare Gas Compliance</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Tracking and minimizing flare and vent gas under regulation.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Workforce Exposure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Dispatching technicians to dangerous sites for routine checks.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Data Latency</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Slow data updates from field sensors preventing immediate alarm response.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Refinement Yields</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Feedstock variability limiting refinery product yields.
                </p>
              </div>
            </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                {
                                "tag": "SCADA",
                                "val": "30% faster response",
                                "title": "Pipeline Leak Analytics",
                                "desc": "Real-time flow-balancing algorithms identifying leaks instantly.",
                ...
                },
                {
                                ...
                                "desc": "Vibration analytics predicting remote turbine and compressor failures.",
                                "img": "https://images.unsplash.com/photo-1531538606174-0f90ff5dce83?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Low-latency telemetry",
                                "title": "Wellhead Telemetry",
                                "desc": "Low-power edge devices streaming pressure and flow rates.",
                                "img": "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Vision AI",
                                "val": "Zero safety breaches",
                                "title": "Flare Flare Monitoring",
                                "desc": "Vision AI tracking flare emissions and sizing to ensure compliance.",
                                "img": "https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Security",
                                "val": "Zero-trust OT",
                                "title": "Zoned Network Protection",
                                "desc": "Securing SCADA and safety systems according to IEC 62443.",
                                "img": "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "15% lower emissions",
                                "title": "Emissions Reporting",
                                "desc": "Centralized dashboard for tracking greenhouse gas metrics.",
                                "img": "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Twin",
                                "val": "Optimized refinery",
                                "title": "Refinery Digital Twin",
                                "desc": "Real-time process model optimizing fractionating column yields.",
                                "img": "https://images.unsplash.com/photo-1591453089816-0fbb971b454c?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Logistics",
                                "val": "Smooth distribution",
                                "title": "Terminal Dispatch",
                                "desc": "Automated pipeline and tanker loading scheduling.",
                                "img": "https://images.unsplash.com/photo-1508873535684-277a3cbcc4e8?auto=format&fit=crop&w=600&q=80"
                }
].map((item, idx) => (
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Oil & Gas operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Leak Response", val: "30% reduction", desc: "Vast improvement in environmental leak detection times.", icon: TrendingUp },
                    { title: "Unscheduled Downtime", val: "20% reduction", desc: "Proactive alerts on compressors and wellhead pumps.", icon: Clock },
                    { title: "Grid Cybersecurity", val: "IEC 62443 certified", desc: "Complete protection of process network segments.", icon: Cpu },
                    { title: "Carbon Intensity", val: "15% reduction", desc: "Minimized flaring through automation.", icon: Award },
                    { title: "Asset Tracking", val: "100% remote visible", desc: "Complete instrumentation of offshore and land platforms.", icon: Zap },
                    { title: "Safety Incidents", val: "Zero incidents", desc: "Reduction of manual site checks in hazardous areas.", icon: ShieldAlert },
                    { title: "Refinery Yield", val: "Optimized yield", desc: "Higher yield from crude feed variability.", icon: Database },
                    { title: "Regulatory Audits", val: "Automated", desc: "Instant reports for regulatory environmental agencies.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Oil & Gas organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Oil & Gas Operations?</span>
            </h2>
