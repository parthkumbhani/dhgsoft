          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Deliver safe, traceable, and consistent product at scale with intelligent recipe management, real-time quality, and connected packaging lines.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Food & Beverages</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Food & beverage manufacturers operate high-speed, high-mix environments where packaging OEE, recipe fidelity, and regulatory compliance are essential for profitability. End-to-end trace capability is key to protecting safety and brand equity.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Continuous processing and automated batching",
                      "Dynamic digital recipes for rapid SKU changes",
                      "In-line PAT sensors and automated quality checks",
                      "Global farm-to-shelf traceability compliance",
                      "High-speed line OEE and scrap tracking"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Batch to Connected Execution</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps food & beverage producers connect legacy plant floors with central ERP/MES to automate compliance records, optimize packaging lines, and minimize changeover waste.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    ...
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global F&B market value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">25%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in waste with recipe optimization</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Higher OEE on packaging lines</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">100%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Batch traceability farm-to-shelf</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Recipe safety", "High product mix", "Yield optimization", "Recall protection"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Packaging line OEE", "Changeover speed", "Clean-in-place uptime", "Compliance logs"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Food & Beverages Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Recipe Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  SKU proliferation and customization multiplying formulation variants.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Line Changeovers</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  High-mix production requiring rapid line changeovers without scrap.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Food Safety</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Contamination and recall risks driving strict HACCP compliance.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cold Chain Integrity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Temperature-sensitive products requiring end-to-end environment visibility.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Waste & Yield</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Raw material variability driving unpredictable product yield and waste.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Packaging OEE</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  High-speed packaging lines exposing every second of operational downtime.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Labor Volatility</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  High worker turnover and training gaps leading to quality exceptions.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Traceability Mandates</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Farm-to-shelf traceability required across global regulatory environments.
                </p>
              </div>
            </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                {
                                "tag": "MES",
                                "val": "Zero changeover error",
                                "title": "Recipe Management",
                                "desc": "Centralized recipe control with electronic version approval and enforcement.",
                ...
                },
                {
                                ...
                                "desc": "Continuous temperature and humidity across storage and distribution.",
                ...
                },
                {
                                ...
                                "desc": "ML models predicting yield from raw material variability.",
                ...
                },
                {
                                ...
                                "desc": "Automated defect detection on high-speed packaging lines.",
                ...
                },
                {
                                ...
                                "val": "30% OEE gain",
                                "title": "Packaging OEE",
                                "desc": "Real-time OEE with root cause analytics on every line.",
                                "img": "https://images.unsplash.com/photo-1516321165247-4aa89a48be28?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Traceability",
                                "val": "Farm to shelf",
                                "title": "Full Traceability",
                                "desc": "Lot-level genealogy meeting FSMA and global mandates.",
                ...
                },
                {
                                ...
                                "desc": "Real-time utility consumption and reduction planning.",
                ...
                },
                {
                                ...
                                "desc": "Sensor-based equipment health across mixers, fillers, and packers.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Food & Beverages operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Packaging OEE", val: "30% higher", desc: "Real-time OEE optimization at station level.", icon: TrendingUp },
                    { title: "Product Waste", val: "25% less", desc: "Reduction in product waste through yield optimization.", icon: AlertTriangle },
                    { title: "Food Safety", val: "100% traceability", desc: "Complete farm-to-shelf batch traceability.", icon: Cpu },
                    { title: "Product Integrity", val: "Cold chain proof", desc: "Continuous temperature and environment tracking.", icon: ShieldAlert },
                    { title: "Line Flexibility", val: "Rapid changeover", desc: "Recipe-driven SKU switching.", icon: Zap },
                    { title: "Safety Confidence", val: "Zero recalls", desc: "Automated vision inspection.", icon: Award },
                    { title: "Sustainability", val: "Utility reduction", desc: "Water and energy consumption tracking.", icon: Database },
                    { title: "Uptime", val: "Predictable", desc: "Condition-based maintenance across lines.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Food & Beverages organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Food & Beverages Operations?</span>
            </h2>
