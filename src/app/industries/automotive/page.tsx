          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                From ICE to EV, from assembly to autonomous — DHGsoft helps automotive OEMs and suppliers build the connected, agile, and intelligent factories of tomorrow.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Automotive</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    The automotive industry is undergoing generational change. Electrification, software-defined vehicles, autonomous driving, and shared mobility are transforming both what vehicles are and how they're built. Manufacturers who master digital operations will lead this transition.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "EV transformation reshaping production footprints",
                      "Gigafactories and battery manufacturing scale-up",
                      "Software-defined vehicle architectures",
                      "Autonomous manufacturing and lights-out plants",
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Assembly Line to Connected Ecosystem</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft partners with OEMs and Tier 1 suppliers to modernize legacy plants, ramp new EV facilities, and integrate manufacturing with product, supply chain, and after-sales digital ecosystems.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$9T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Automotive market by 2030</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">40%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">EV share of new sales by 2030</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">35%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Productivity gain with connected operations</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">50%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Faster ramp-up with digital commissioning</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["EV transition", "Chip shortage", "New OEMs", "Sustainability targets"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Ramp velocity", "First-time quality", "Cost per vehicle", "Flexible manufacturing"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Automotive Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">EV Ramp Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  New EV lines require simultaneous engineering, tooling, and process qualification at speed.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Battery Traceability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Cell-to-pack genealogy demanded by regulators and warranty operations.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Legacy Plant Modernization</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Retrofitting ICE plants to serve EV and hybrid production without disruption.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Supply Chain Fragility</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Semiconductor shortages and just-in-time exposure requiring resilience.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Quality at Speed</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Heterogeneous lines and components requiring automated traceability and testing.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Skill Transformation</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Workforce shift from mechanical to electrical and software competencies.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Data Fragmentation</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Disconnected engineering, manufacturing, and after-sales data.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Sustainability Reporting</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Carbon footprint tracking mandated across the value chain.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                ...
                                "desc": "Simulate and validate production lines before physical build, cutting ramp time in half.",
                ...
                },
                {
                                ...
                                "desc": "Full cell-to-pack genealogy for warranty, recall, and second-life applications.",
                ...
                },
                {
                                ...
                                "desc": "Vision AI detecting defects invisible to human inspection at line speed.",
                ...
                },
                {
                                ...
                                "val": "Line balancing",
                                "title": "Real-time OEE",
                                "desc": "Cycle-time and takt tracking across every station and shift.",
                                "img": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "MES",
                                "val": "Zero rework",
                                "title": "Andon & Line Control",
                                "desc": "Digital andon, quality alerts, and line stop analytics preventing rework.",
                                "img": "https://images.unsplash.com/photo-1607799279861-4dd421887fb3?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "Predictive quality",
                                "title": "Warranty Analytics",
                                "desc": "Field failure correlation back to production parameters for root cause.",
                ...
                },
                {
                                ...
                                "desc": "Per-vehicle carbon footprint calculation for regulatory disclosure.",
                                "img": "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Robotics",
                                "val": "Flexible automation",
                                "title": "Collaborative Robotics",
                                "desc": "Cobot deployment for mixed-model assembly and rapid retooling.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Automotive operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "EV Line Ramp", val: "50% faster", desc: "Virtual commissioning cuts physical trial time.", icon: TrendingUp },
                    { title: "Line Efficiency", val: "35% productivity", desc: "Real-time OEE optimization at station level.", icon: Clock },
                    { title: "Battery Traceability", val: "Zero recall risk", desc: "Full genealogy across cells, modules, packs.", icon: Cpu },
                    { title: "First-Pass Quality", val: "99.5%+", desc: "AI inspection at line speed.", icon: Award },
                    { title: "Supply Chain", val: "Full transparency", desc: "Tier N visibility and disruption response.", icon: Zap },
                    { title: "Sustainability", val: "Scope 3 ready", desc: "Per-vehicle carbon accounting.", icon: Database },
                    { title: "Flexibility", val: "Rapid retooling", desc: "Mixed-model assembly with cobot support.", icon: Settings },
                    { title: "Warranty Reduction", val: "Data-driven", desc: "Field-to-factory feedback loops.", icon: Settings2 }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Automotive organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Automotive Operations?</span>
            </h2>
