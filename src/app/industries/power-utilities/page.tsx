          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Orchestrate generation, transmission, and distribution — with real-time grid automation, renewable DER integration, and predictive asset reliability.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Power & Utilities</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Utilities are faced with grid complexity due to the rise of Distributed Energy Resources (DER) like solar and wind, coupled with surging demand from data centers. Modernizing distribution grids with real-time monitoring and smart substation automation is essential.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Smart substation automation and IEC 61850",
                      "Vibration and thermal analytics on transformers",
                      "Predictive grid outage prevention models",
                      "Carbon accounting for clean energy portfolios"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Fossil to Flexible Grid</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps utility operators transition to a modern grid by integrating time-series SCADA data with cloud analytics, enabling real-time demand response and preventing substation failures.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">99.999%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Grid reliability uptime target</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">35%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Increase in renewable capacity hosting</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">40%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Lower substation maintenance costs</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">Zero</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Unplanned grid substation outages</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Renewable integration", " Surging demand", "Aging substation assets", "Grid security"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Transformer health", "Outage prediction", "Microgrid scheduling", "DER integration"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Power & Utilities Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Grid Overloads</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Managing bidirectional power flow from decentralized solar and wind.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Substation Failure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Aging high-voltage transformers operating past design life.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Outage Restoration</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of granular grid sensor data to locate faults and dispatch crews.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Grid Intrusion Risk</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Distributed IoT devices increasing the grid's cyber attack surface.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Peak Demand Spikes</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Extreme weather events driving grid volatility and spot prices.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Legacy SCADA</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Low-bandwidth links to substation RTUs blocking analytics.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Regulatory Audits</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Stricter reporting on reliability indices (SAIDI/SAIFI).
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Renewable Curtailment</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Grid instability forcing operators to curtail wind and solar.
                </p>
              </div>
            </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                {
                                "tag": "SCADA",
                                "val": "IEC 61850 standard",
                                "title": "Substation Automation",
                                "desc": "Standardized substation telemetry integration and automated protection loops.",
                                "img": "https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Wind/solar tracked",
                                "title": "Renewable Integration",
                                "desc": "DERMS platforms correlating renewable output with demand curves.",
                                "img": "https://images.unsplash.com/photo-1466611653911-95081537e5b7?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "AI",
                                "val": "40% cost reduction",
                                "title": "Transformer Health",
                                "desc": "Dissolved gas analysis (DGA) and thermal modeling to predict failure.",
                                "img": "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "Zero peak outages",
                                "title": "Demand Response",
                                "desc": "AI load forecasting predicting peak demand spikes and coordinating dispatch.",
                                "img": "https://images.unsplash.com/photo-1605980776566-0486c3ac7617?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Twin",
                                "val": "Simulated grid",
                                "title": "Grid Digital Twin",
                                "desc": "Real-time grid topology model simulating load-flow scenarios.",
                                "img": "https://images.unsplash.com/photo-1498084393753-b411b2d26b34?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Security",
                                "val": "Zero grid intrusions",
                                "title": "Substation Zero Trust",
                                "desc": "Zoning substation network traffic with OT-native firewalls.",
                                "img": "https://images.unsplash.com/photo-1569003339405-ea396a5a8a90?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Database",
                                "val": "1-click compliance",
                                "title": "Reliability KPI Engine",
                                "desc": "Automated calculation of SAIDI/SAIFI indices for board reporting.",
                                "img": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Microgrid",
                                "val": "Localized resilience",
                                "title": "Microgrid Orchestration",
                                "desc": "Local energy generation coordination for storm resilience.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Power & Utilities operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Grid Reliability", val: "99.999% grid uptime", desc: "Fewer outages and faster restoration times.", icon: TrendingUp },
                    { title: "DER Hosting", val: "35% capacity gain", desc: "Smooth connection of residential and utility solar.", icon: Clock },
                    { title: "Asset Preservation", val: "40% lower maintenance", desc: "Condition-based maintenance on substation assets.", icon: Cpu },
                    { title: "Load Balancing", val: "Zero peak outages", desc: "Elimination of demand outages during extreme weather.", icon: Award },
                    { title: "SAIDI/SAIFI Auditing", val: "1-click audit ready", desc: "Instant compliance reporting for public boards.", icon: Zap },
                    { title: "Grid Cybersecurity", val: "Airtight OT safety", desc: "Secured substation access preventing grid threats.", icon: ShieldAlert },
                    { title: "Emissions Compliance", val: "15% carbon cut", desc: "Better visibility of renewable power mix.", icon: Database },
                    { title: "Grid Resilience", val: "Storm ready", desc: "Microgrid isolation capability to protect critical loops.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Power & Utilities organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Power & Utilities Operations?</span>
            </h2>
