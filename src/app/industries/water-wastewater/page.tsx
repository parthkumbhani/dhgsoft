          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Ensure water safety and optimize treatment plants — with real-time pH and quality analytics, SCADA modernization, and distribution leak detection.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Water & Wastewater</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Water utilities operate distribution pipes, lift stations, and complex treatment plants under tight municipal budgets. Preventing water loss (Non-Revenue Water), optimizing energy in aeration loops, and ensuring regulatory chemical dosing compliance require secure and reliable automation.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Smart water distribution leak detection",
                      "Aeration loop dissolved oxygen control",
                      "Automated chemical dosing platforms",
                      "SCADA alarm rationalization networks",
                      "Lift station telemetry and pump health diagnostics"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Telemetry to Clean Quality</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps water districts upgrade legacy SCADA platforms, connect remote pump stations using low-power IoT, and build real-time dashboards to prove compliance.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$800B</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global water utility market value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in water loss (Non-Revenue Water)</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">20%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Energy savings in aeration blowers</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">100%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Compliance with clean water standards</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Water conservation", "Pump efficiency", "Quality compliance", "Leak mitigation"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Chemical optimization", "Aeration OEE", "SCADA zoning", "Lift station telemetry"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Water & Wastewater Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Water Loss</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Undetected pipe leaks causing massive Non-Revenue Water losses.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Aeration Energy</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  High energy consumption of blowers in wastewater aeration tanks.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Dosing Accuracy</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Under- or over-dosing chemicals risking quality or increasing costs.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Aging Pipelines</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Pipes and pumps operating past useful life causing main breaks.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">SCADA Alarm Floods</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  NOC operators overwhelmed by nuisance alarms during storm events.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Isolated Lift Stations</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lift stations lacking telemetry, requiring manual daily inspection.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Stormwater Inflow</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Inflow and infiltration overloading treatment capacity during rains.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Compliance Audits</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Time-consuming manual collection of pH and quality test reports.
                </p>
              </div>
            </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                {
                                "tag": "SCADA",
                                "val": "20% energy savings",
                                "title": "Aeration Control",
                                "desc": "Automating blower speed based on real-time dissolved oxygen sensors.",
                                "img": "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "30% water loss cut",
                                "title": "Distribution Leak Detection",
                                "desc": "Acoustic edge sensors and flow meters pinpointing grid leaks.",
                                "img": "https://images.unsplash.com/photo-1605379399642-870262d3d051?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "AI",
                                "val": "Chemical cost optimized",
                                "title": "Predictive Chemical Dosing",
                                "desc": "Correlating incoming turbidity with dosing to prevent chemical waste.",
                                "img": "https://images.unsplash.com/photo-1616401784845-180882ba9ba8?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "99.9% uptime",
                                "title": "Pump Station Diagnostics",
                                "desc": "Predictive vibration tracking for high-flow water pumps.",
                                "img": "https://images.unsplash.com/photo-1590959651373-a3db0f38a961?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Telemetry",
                                "val": "Always connected",
                                "title": "Lift Station IoT",
                                "desc": "Cellular/satellite telemetry for remote wastewater lifts.",
                ...
                },
                {
                                ...
                                "desc": "Simulate pressure changes in pipelines to prevent hammer and breaks.",
                                "img": "https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Database",
                                "val": "Audit ready",
                                "title": "Compliance Log Automation",
                                "desc": "Database syncing of water quality metrics with regulatory formats.",
                                "img": "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Security",
                                "val": "Zero breach",
                                "title": "SCADA Network Zoning",
                                "desc": "Securing treatment plant control networks from external risks.",
                                "img": "https://images.unsplash.com/photo-1612538498456-e861df91d4d0?auto=format&fit=crop&w=600&q=80"
                }
].map((item, idx) => (
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Water & Wastewater operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Water Quality", val: "100% GxP certified", desc: "Consistent compliance with environmental protection standards.", icon: TrendingUp },
                    { title: "Non-Revenue Water", val: "30% reduction", desc: "Quick detection of pipeline leaks across distribution.", icon: Clock },
                    { title: "Treatment Energy", val: "20% energy cut", desc: "Optimized blowers in biological treatment loops.", icon: Zap },
                    { title: "Pump Availability", val: "Zero downtime", desc: "Avoidance of pump motor burnouts via thermal alerts.", icon: Award },
                    { title: "SCADA Security", val: "Zoned & secure", desc: "IEC 62443 zone segregation across plant RTUs.", icon: Cpu },
                    { title: "Chemical Savings", val: "15% cost saving", desc: "turbidity-optimized coagulant dosing.", icon: Database },
                    { title: "Audit Compliance", val: "Instant logs", desc: "Instant water quality compliance logs.", icon: ShieldAlert },
                    { title: "Operator Safety", val: "Reduced dispatch", desc: "Fewer manual remote station checks.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Water & Wastewater organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Water & Wastewater Operations?</span>
            </h2>
