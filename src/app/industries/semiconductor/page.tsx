          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                From wafer to package, DHGsoft enables the ultra-precise, ultra-clean, ultra-connected operations that modern semiconductor manufacturing demands.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Semiconductor</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    The semiconductor industry sits at the heart of every digital transformation. As process nodes shrink and geopolitics reshape supply chains, fabs must combine cleanroom precision, real-time analytics, and integrated automation to remain competitive.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Sub-3nm process node scale-up",
                      "Advanced packaging and chiplet architectures",
                      "Regional fab expansion and reshoring",
                      "AI-driven defect classification",
                      "Copy-exactly and virtual fab initiatives"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Automation to Autonomous Fabs</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps semiconductor manufacturers connect equipment, MES, EDA, and enterprise data into a unified intelligence layer that supports yield ramp, cycle-time reduction, and world-class equipment utilization.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$1T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global semiconductor market by 2030</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">25%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Yield ramp acceleration</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">40%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in unplanned tool downtime</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">15%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Cycle time reduction</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["AI compute demand", "Reshoring incentives", "Node advancement", "Advanced packaging"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Yield ramp", "Tool utilization", "Cycle time", "Contamination control"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Semiconductor Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Yield Ramp Pressure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  New nodes demand faster time-to-mature-yield than ever.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Tool Interoperability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  SECS/GEM, SEMI E10, and heterogeneous OEM equipment integration.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Contamination Control</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Nanometer defects driving multi-million-dollar wafer losses.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cleanroom Compliance</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Strict environmental monitoring and control requirements.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">APC/FDC Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Advanced process control across thousands of parameters.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cycle Time Pressure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Wafer-out targets requiring second-level optimization.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Fab Data Deluge</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Terabytes per day requiring intelligent triage and storage.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Talent Scarcity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Global shortage of process, integration, and equipment engineers.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                ...
                                "desc": "ML classification of wafer defect maps for faster root cause.",
                                "img": "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "APC",
                                "val": "Excursion prevented",
                                "title": "Advanced Process Control",
                                "desc": "Real-time recipe adjustment across thousands of process variables.",
                                "img": "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "MES",
                                "val": "Cycle time",
                                "title": "WIP Optimization",
                                "desc": "Wafer flow optimization across bottleneck tools and shifts.",
                                "img": "https://images.unsplash.com/photo-1555664424-778a1e5e1b48?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "40% less downtime",
                                "title": "Predictive Tool Health",
                                "desc": "Sensor-based tool failure prediction and proactive maintenance scheduling.",
                                "img": "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Traceability",
                                "val": "Full genealogy",
                                "title": "Wafer & Lot Traceability",
                                "desc": "Complete lot-level genealogy from raw wafer to finished die.",
                ...
                },
                {
                                ...
                                "val": "Copy exactly",
                                "title": "Virtual Fab",
                                "desc": "Digital twin of process modules for copy-exactly deployment across sites.",
                                "img": "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Cleanroom assured",
                                "title": "Environmental Monitoring",
                                "desc": "Continuous cleanroom particle, temperature, and humidity monitoring.",
                                "img": "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Cybersecurity",
                                "val": "Zero compromise",
                                "title": "Fab Cybersecurity",
                                "desc": "Secure OT connectivity protecting recipes and IP from exfiltration.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Semiconductor operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Yield Ramp", val: "25% faster", desc: "ML-accelerated defect learning cycles.", icon: TrendingUp },
                    { title: "Tool Downtime", val: "40% reduction", desc: "Predictive equipment health.", icon: Clock },
                    { title: "Cycle Time", val: "15% shorter", desc: "WIP and dispatch optimization.", icon: Cpu },
                    { title: "Multi-fab Consistency", val: "Copy exactly", desc: "Digital twin-enabled site replication.", icon: Award },
                    { title: "Process Stability", val: "Zero excursions", desc: "APC and FDC preventing drift.", icon: Zap },
                    { title: "Compliance", val: "Cleanroom cert", desc: "Continuous environmental proof.", icon: Database },
                    { title: "Wafer Genealogy", val: "Full trace", desc: "End-to-end lot tracking.", icon: Settings },
                    { title: "Cybersecurity", val: "IP secure", desc: "OT-native protection.", icon: Settings2 }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Semiconductor organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Semiconductor Operations?</span>
            </h2>
