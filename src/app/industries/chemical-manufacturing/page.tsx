          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Improve safety, reliability, and efficiency in chemical processing — with real-time telemetry, process optimization, and connected operations.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Chemical Manufacturing</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Chemical plants operate highly complex and hazardous processes where safety, asset uptime, and energy efficiency directly determine profitability. Digitalization enables plants to operate with precision, avoiding process excursions and tracking emissions in real time.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Predictive machinery diagnostics for safety critical assets",
                      "SCADA network upgrades and secure OT networks",
                      "Scope 1 emissions tracking and environmental compliance",
                      "Real-time pipeline and tank farm telemetry"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Process Safety to Enterprise Value</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft partners with chemical manufacturers to integrate edge telemetry with centralized databases, delivering process safety visibility and helping plant operations improve OEE.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$5T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global chemical industry value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">20%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Energy reduction via APC</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">40%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Fewer safety incidents with connected ops</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">15%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Throughput gain with real-time optimization</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Process safety", "Energy costs", "Feedstock variability", "Regulatory reporting"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Asset reliability", "DCS modernization", "Alarm rationalization", "Carbon accounting"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Chemical Manufacturing Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Process Safety</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Complex reactions requiring rigorous layer-of-protection analysis.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Energy Intensity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Rising energy costs dominating operating expenses.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Feedstock Volatility</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Raw material variability driving yield and margin swings.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Legacy DCS</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Aging distributed control systems limiting analytics access.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Environmental Reporting</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Air, water, and waste reporting mandates multiplying.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Asset Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Rotating equipment, reactors, and columns requiring specialist care.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Alarm Management</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Alarm floods reducing operator effectiveness.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Workforce Aging</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Retirement of process experts creating tribal knowledge risk.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                ...
                                "desc": "Multivariable control optimizing yield and stability.",
                ...
                },
                {
                                ...
                                "desc": "Rotating equipment failure prediction weeks in advance.",
                ...
                },
                {
                                ...
                                "desc": "Site-wide energy tracking and reduction opportunities.",
                ...
                },
                {
                                ...
                                "desc": "Digital layer-of-protection monitoring and alerts.",
                                "img": "https://images.unsplash.com/photo-1622630998477-20aa696ecb05?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Twin",
                                "val": "Virtual startup",
                                "title": "Reactor Digital Twin",
                                "desc": "Simulate reactor behavior for scenario planning and training.",
                ...
                },
                {
                                ...
                                "desc": "Continuous emissions monitoring and reporting.",
                                "img": "https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "MES",
                                "val": "Batch consistency",
                                "title": "Batch Optimization",
                                "desc": "Golden batch analytics and deviation prevention.",
                ...
                },
                {
                                ...
                                "desc": "OT-native protection for process control networks.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Chemical Manufacturing operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Production Uplift", val: "20% throughput", desc: "Throughput improvement using Advanced Process Control.", icon: TrendingUp },
                    { title: "Safety Performance", val: "40% fewer", desc: "Reduction in process safety incidents.", icon: Clock },
                    { title: "Energy Efficiency", val: "20% energy cut", desc: "Site-wide energy reduction and savings.", icon: Zap },
                    { title: "Reliability", val: "Zero unplanned", desc: "Avoidance of unplanned shutdowns with predictive reliability.", icon: Award },
                    { title: "Environmental", val: "Emissions verified", desc: "Compliance with air, water, and waste mandates.", icon: ShieldAlert },
                    { title: "Quality", val: "Batch consistency", desc: "Consistent output quality using golden batch enforcement.", icon: Database },
                    { title: "Operator Focus", val: "Alarm rationalized", desc: "Better control room efficiency with alarm design.", icon: Settings },
                    { title: "Workforce", val: "Knowledge captured", desc: "Digitizing process logs and operations to prevent knowledge gaps.", icon: UserCheck }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Chemical Manufacturing organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Chemical Manufacturing Operations?</span>
            </h2>
