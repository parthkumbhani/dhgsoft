          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Deliver massive infrastructure and plant projects on-time and on-budget — with BIM digital twins, real-time construction site telemetry, and integrated handover operations.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Engineering, Procurement & Construction (EPC)</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    EPC firms manage massive, complex projects where delays and rework are costly. Bridging the gap between 3D design models (BIM), active field work tracking, and final client handovers requires connected data workflows.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "BIM-to-Field digital twin coordination",
                      "Real-time site material and supply chain tracking",
                      "Automated procurement version control",
                      "Site safety telemetry and zone monitoring",
                      "Digital handovers with unified data packages"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Blueprints to Plant Startup</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft partners with construction and engineering leaders to integrate design data with actual field construction status, providing unified visibility and project control.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$12T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global construction market by 2030</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in commissioning delays</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">20%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in project cost-overruns</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">100%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Digital blueprint data integrity</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Project scheduling", "Cost overruns", "Subcontractor sync", "Handover delays"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["BIM integration", "Field telemetry", "Safety tracking", "Handover automation"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Engineering, Procurement & Construction (EPC) Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Project Overruns</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Disconnected schedules leading to material wait times and delays.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">BIM-to-Field Gap</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Design changes in offices not reflecting on active job sites.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Supply Chain Gaps</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Critical equipment delivery delays stalling site commissioning.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Commissioning Handovers</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Manual collection of testing data delaying project closeouts.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Safety Risks</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Hazards around heavy crane setups and active work zones.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Subcontractor Coordination</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Tracking status across multiple trade vendors.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Quality Rework</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Incorrect installations requiring expensive concrete or pipe rework.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Document Integrity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Manual spreadsheet version control for engineering logs.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                ...
                                "desc": "Integrating 3D CAD/BIM data with active construction progress.",
                                "img": "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Logistics",
                                "val": "Zero supply delays",
                                "title": "Material Supply Tracking",
                                "desc": "Tracking critical piping and electrical skids from factory to site.",
                                "img": "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Database",
                                "val": "Instant handover pack",
                                "title": "Digital Handover Packages",
                                "desc": "Automated aggregation of testing and QA certs for asset owners.",
                                "img": "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Crane OEE optimized",
                                "title": "Heavy Machine Telemetry",
                                "desc": "Vibration and load telemetry on cranes and concrete operations.",
                                "img": "https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Safety",
                                "val": "Zero zone breaches",
                                "title": "Field Safety Telemetry",
                                "desc": "Location tags and automated hazard warnings around crane zones.",
                                "img": "https://images.unsplash.com/photo-1562813733-b31f71025d54?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "Progress dashboard",
                                "title": "Visual Progress Tracking",
                                "desc": "Photo/drone scans compared automatically to project Gantt tasks.",
                                "img": "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Procurement",
                                "val": "Automated RFQs",
                                "title": "Automated Material Orders",
                                "desc": "Integrated supplier ordering linked to actual field installation speed.",
                                "img": "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Quality",
                                "val": "Zero rework leaks",
                                "title": "QA Weld Inspection",
                                "desc": "Digitized NDT/UT testing logs synced with isometric plant blueprints.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Engineering, Procurement & Construction (EPC) operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Project Schedule", val: "On-time handover", desc: "Drastic reduction in final commissioning delays.", icon: TrendingUp },
                    { title: "Project Cost Control", val: "20% cost cut", desc: "Fewer material wait hours and trade delays.", icon: Clock },
                    { title: "Startup Quality", val: "Zero-rework", desc: "Fewer structural pipe and valve alignment issues.", icon: Cpu },
                    { title: "Site Safety", val: "Zero incidents target", desc: "Real-time exclusion zone warnings for workers.", icon: Award },
                    { title: "BIM Alignment", val: "Fully connected", desc: "Immediate availability of design updates in the field.", icon: Zap },
                    { title: "Owner Handover", val: "100% digital pack", desc: "Frictionless transfer of asset records to operations.", icon: Database },
                    { title: "Vendor Audits", val: "Subcontractor transparency", desc: "Consistent tracking of subcontractor output status.", icon: ShieldAlert },
                    { title: "Supply Chain", val: "Integrated tracking", desc: "No last-minute logistics gaps on specialized parts.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Engineering, Procurement & Construction (EPC) organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Engineering, Procurement & Construction (EPC) Operations?</span>
            </h2>
