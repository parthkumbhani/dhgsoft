          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Maximize throughput and improve site safety — with fleet automation telemetry, predictive crusher maintenance, and end-to-end supply chain integration.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Mining & Metals</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Mining and metal producers operate under harsh conditions where heavy machinery uptime, worker safety, and transport logistics determine profitability. Integrating fleet operations, processing crushers, and transport rail into a unified telemetry stream drives value.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Autonomous haulage fleet telemetry integration",
                      "Crusher asset health and wear monitoring",
                      "Real-time pit-to-port supply chain tracking",
                      "Environmental dust and water tailings telemetry",
                      "Energy load management for metal refining mills"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Excavation to Process Control</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps mining companies automate heavy fleets, deploy predictive diagnostics for crushers and conveyors, and optimize transport schedules from pit to port.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$2.2T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Metals and mining market value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">25%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Haul fleet utilization increase</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in haul fuel consumption</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">Zero</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Worker safety incidents goal</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Fleet OEE", "Remote site safety", "Crusher reliability", "Tailings monitoring"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Transport logistics", "Mill energy load", "Dust compliance", "Ore yield tracking"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Mining & Metals Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Fleet Downtime</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Unplanned maintenance on haul trucks stalling mine excavation.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Remote Isolation</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of field connectivity across sprawling, open-pit mines.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Crusher Failure</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Crusher jaw or cone wear causing major downstream refining delays.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Safety Hazards</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Exposing workers to heavy machinery, dust, and toxic fumes.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Supply Gaps</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Mismatches between ore extraction, rail shipping, and port shipping.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Energy Costs</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  High energy consumption at smelting and refining mills.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Tailings Risk</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Monitoring tailings dams to prevent structural failure.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Process Yield</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Ore grade variability leading to inconsistent refining yield.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                "tag": "IIoT",
                                "val": "25% fleet gain",
                                "title": "Haul Truck Telemetry",
                                "desc": "Vibration, tire-pressure, and engine telematics for haul fleets.",
                                "img": "https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "AI",
                                "val": "Zero crusher outages",
                                "title": "Crusher Diagnostics",
                                "desc": "Acoustic and motor load analytics predicting crusher wear.",
                                "img": "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "SCADA",
                                "val": "Real-time safety OEE",
                                "title": "Conveyor Belt Health",
                                "desc": "Thermal imaging and rip detection on long-distance conveyors.",
                                "img": "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Logistics",
                                "val": "Optimized dispatch",
                                "title": "Pit-to-Port Supply Integration",
                                "desc": "Tracking ore grade and load from extraction to rail cars and port silos.",
                                "img": "https://images.unsplash.com/photo-1516937941344-00b4e0337589?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Telemetry",
                                "val": "Dam safety verified",
                                "title": "Tailings Dam Monitoring",
                                "desc": "Piezometer and satellite data streaming to assess dam structure.",
                                "img": "https://images.unsplash.com/photo-1618042164219-62c820f10723?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "12% mill savings",
                                "title": "Mill Energy Load Balancing",
                                "desc": "Optimizing mill grinder schedules to avoid peak utility pricing.",
                                "img": "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Autonomous",
                                "val": "98% fleet OEE",
                                "title": "Autonomous Drill Sync",
                                "desc": "Integrating autonomous drill telemetry with mine planning tools.",
                                "img": "https://images.unsplash.com/photo-1508962914676-134849a727f0?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Safety",
                                "val": "Dust exposure reduced",
                                "title": "Environmental Dust Telemetry",
                                "desc": "Continuous ambient dust monitoring and automated watering spray sync.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Mining & Metals operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Fleet Utilization", val: "25% higher usage", desc: "Reduction in truck queue and empty travel times.", icon: TrendingUp },
                    { title: "Fuel Consumption", val: "30% fuel cut", desc: "Optimized haul profiles and reduced idling.", icon: Clock },
                    { title: "Crusher Reliability", val: "Zero crusher halts", desc: "Preventative maintenance before jaw breaks.", icon: Cpu },
                    { title: "Worker Safety", val: "Zero incidents target", desc: "Automated dust suppression and machine safety zones.", icon: Award },
                    { title: "Supply Chain Sync", val: "Smooth flow", desc: "Close coordination of ore grade from mine to ships.", icon: Zap },
                    { title: "Energy Optimization", val: "12% savings", desc: "Peak-load shaving at metal processing mills.", icon: Database },
                    { title: "Tailings Integrity", val: "100% dam compliance", desc: "Continuous data validation for local agencies.", icon: ShieldAlert },
                    { title: "Grade Predictability", val: "98% accuracy", desc: "Accurate prediction of processing yield.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Mining & Metals organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Mining & Metals Operations?</span>
            </h2>
