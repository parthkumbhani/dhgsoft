      ...
      <main className="flex-grow">
        ...
        <Section variant="ink" size="hero" containerSize="wide" className="relative min-h-screen flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0 pointer-events-none">
            <Image
              src="https://img.rocket.new/generatedImages/rocket_gen_img_1476b3f2d-1777540591762.png"
          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Connect machines, people, processes, and enterprise systems through AI-powered automation, industrial data platforms, and digital engineering.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Industrial Manufacturing</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Manufacturing is undergoing its most significant transformation in decades. Industry 4.0 technologies are reshaping how factories operate, compete, and deliver value. The convergence of OT and IT systems, combined with AI and cloud capabilities, is enabling a new era of intelligent, connected manufacturing.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Smart Factory adoption accelerating across all tiers",
                      "Industrial IoT proliferation and edge computing",
                      "AI-driven quality control and defect detection",
                      "Digital Twin technology for virtual commissioning",
                      "Sustainable manufacturing and carbon reduction mandates"
                    ].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">Digital Transformation Journey</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    From isolated automation islands to fully connected, intelligent manufacturing enterprises — DHGsoft guides organizations through every phase of their digital transformation, building sustainable competitive advantage through technology.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$1.2T</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global smart manufacturing market by 2030</span>
                  </div>

                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">45%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in unplanned downtime with predictive maintenance</span>
                  </div>

                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Improvement in OEE with digital factory solutions</span>
                  </div>

                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">25%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Energy savings through intelligent monitoring</span>
                  </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Competitive pressure", "Labor shortages", "Sustainability mandates", "Customization demand"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Operational excellence", "Asset reliability", "Energy efficiency", "Workforce augmentation"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Manufacturers Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Legacy Automation</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Aging PLCs, DCS, and SCADA systems creating integration barriers and limiting data accessibility.
                </p>
              </div>

              {/* Card 2: Production Downtime */}
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                  <Clock className="w-5 h-5" />
                </div>
                <h5 className="font-extrabold text-txt-strong leading-tight">Production Downtime</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Unplanned equipment failures costing millions per hour with reactive maintenance strategies.
                </p>
              </div>
              ...
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Data Silos</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Disconnected shop-floor and enterprise systems preventing end-to-end data visibility.
                </p>
              </div>

              {/* Card 4: Quality Issues */}
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                  <AlertTriangle className="w-5 h-5" />
                </div>
                <h5 className="font-extrabold text-txt-strong leading-tight">Quality Issues</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Manual inspection processes missing defects, driving up scrap rates and rework costs.
                </p>
              </div>

              {/* Card 5: Asset Reliability */}
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                  <Activity className="w-5 h-5" />
                </div>
                <h5 className="font-extrabold text-txt-strong leading-tight">Asset Reliability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of real-time diagnostics makes tracking health and runtime profiles of machinery difficult.
                </p>
              </div>

              {/* Card 6: Rising Energy Costs */}
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                  <Zap className="w-5 h-5" />
                </div>
                <h5 className="font-extrabold text-txt-strong leading-tight">Rising Energy Costs</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of granular power telemetry leading to hidden consumption and heavy operational leakage.
                </p>
              </div>
              ...
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cybersecurity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  OT/IT connectivity exposing critical control networks to data breaches and sabotage risks.
                </p>
              </div>

              {/* Card 8: Skilled Workforce Gap */}
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                  <UserCheck className="w-5 h-5" />
                </div>
                <h5 className="font-extrabold text-txt-strong leading-tight">Skilled Workforce Gap</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Retiring experts taking tribal knowledge with them, creating major operational capability gaps.
                </p>
              </div>
              ...
              {[
                {
                  ...
                  tag: "AI & Analytics",
                  val: "45% less downtime",
                  desc: "AI-powered equipment failure prediction using vibration, temperature, and operational data to prevent unplanned stoppages.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_119a2eef0-1778745568515.png"
                },
                {
                  title: "Digital Factory",
                  tag: "Digital Twin",
                  val: "End-to-end visibility",
                  desc: "Complete factory digitalization with real-time visibility across all production lines, assets, and processes.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_118eb850a-1772198357361.png"
                },
                {
                  title: "Energy Monitoring",
                  tag: "IIoT",
                  val: "25% energy savings",
                  desc: "Real-time energy consumption tracking and optimization across all plant systems and production areas.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1f87d6b72-1770775388275.png"
                },
                {
                  title: "OEE Improvement",
                  tag: "Analytics",
                  val: "30% OEE gain",
                  desc: "Overall Equipment Effectiveness monitoring and analytics to maximize availability, performance, and quality.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_17fe183a6-1767268435318.png"
                },
                {
                  title: "Asset Performance Management",
                  tag: "APM",
                  val: "Extended asset life",
                  desc: "Comprehensive asset lifecycle optimization combining condition monitoring, reliability analytics, and maintenance planning.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_138525840-1781550260212.png"
                },
                {
                  title: "Digital Logbook",
                  tag: "MES",
                  val: "Zero knowledge loss",
                  desc: "Electronic shift handover and operational records replacing paper-based processes with searchable digital intelligence.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1cf15b768-1783590711771.png"
                },
                {
                  title: "Remote Operations",
                  tag: "Remote OT",
                  val: "Secure 24/7 access",
                  desc: "Secure remote monitoring and control capabilities enabling experts to support operations from anywhere.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_176081d54-1776923140762.png"
                },
                {
                  title: "Production Analytics",
                  tag: "Analytics",
                  val: "Data-driven decisions",
                  desc: "Advanced analytics for production optimization, quality correlation, and throughput improvement.",
                  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1c523ae5f-1773287954372.png"
                }
              ].map((item, idx) => (
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your manufacturing operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Increase Productivity", val: "Up to 35%", desc: "Improvement in production throughput through connected, optimized operations.", icon: TrendingUp },
                { title: "Reduce Downtime", val: "45% Reduction", desc: "Reduction in unplanned equipment failures through predictive maintenance.", icon: Clock },
                { title: "Connected Operations", val: "100% Visibility", desc: "Real-time visibility across the entire plant floor and enterprise.", icon: Cpu },
                { title: "Operational Excellence", val: "Best in Class", desc: "Standardized processes and industry best practices embedded in operations.", icon: Award },
                { title: "Energy Efficiency", val: "25% Savings", desc: "Reduction in energy consumption through intelligent monitoring and optimization.", icon: Zap },
                { title: "Better Decision Making", val: "Data-Driven", desc: "Actionable insights at every level from plant floor to executive dashboard.", icon: Database },
                { title: "Asset Reliability", val: "Extended Life", desc: "Extended asset life and optimized maintenance through condition-based strategies.", icon: Settings },
                { title: "Business Agility", val: "Faster Response", desc: "Rapid adaptation to market changes through connected, intelligent operations.", icon: Settings2 }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for manufacturers worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Manufacturing Operations?</span>
            </h2>
