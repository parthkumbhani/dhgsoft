          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Enable compliant, connected, and efficient pharma and biotech operations through validated automation, batch traceability, and industrial data intelligence.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Life Sciences</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Life sciences manufacturers operate at the intersection of scientific innovation and rigorous regulation. GxP-compliant digitalization, batch integrity, and end-to-end traceability are now non-negotiable — and increasingly the source of competitive advantage.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Continuous manufacturing gaining regulatory acceptance",
                      "Digital batch records and paperless production",
                      "PAT (Process Analytical Technology) adoption",
                      "Serialization and track-and-trace mandates",
                      "AI-driven deviation and quality investigation"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Paper to Predictive</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps pharma and biotech leaders modernize regulated environments — from data historian and MES upgrades to fully connected, AI-augmented production lines that meet 21 CFR Part 11 and Annex 11 requirements.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$450B</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Global pharma market and growing</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Reduction in batch release cycle time</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">50%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Fewer deviations with digital batch records</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">20%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Yield improvement with PAT & analytics</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Regulatory pressure", "Personalized medicine", "Cost containment", "Patent cliffs"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Data integrity", "Batch traceability", "Right-first-time", "Time to market"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Life Sciences Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Regulatory Complexity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Evolving GxP, FDA, and EMA requirements demand continuous validation and audit readiness.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Data Integrity Risks</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Manual records and disconnected systems create ALCOA+ compliance gaps.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Batch Variability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Process drift and manual interventions leading to yield and quality variability.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Legacy MES/LIMS</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Aging systems struggling to keep pace with continuous and personalized manufacturing.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Serialization Burden</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Track-and-trace mandates driving cost and complexity across the supply chain.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Deviation Management</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Time-consuming investigation cycles delaying batch release and impacting output.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Cold Chain Risk</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Temperature excursion visibility gaps threatening product quality and patient safety.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Talent & Knowledge Loss</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Retiring subject matter experts taking process knowledge with them.
                </p>
              </div>
            </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                {
                                "tag": "MES",
                                "val": "50% faster release",
                                "title": "Digital Batch Records",
                                "desc": "Paperless production with real-time review by exception, accelerating batch release.",
                                "img": "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "AI",
                                "val": "Zero investigations",
                                "title": "Deviation Prediction",
                                "desc": "AI-driven early warning of process drift preventing deviations before they occur.",
                                "img": "https://images.unsplash.com/photo-1507537297725-24a1c029d3ca?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "IIoT",
                                "val": "Cold chain assured",
                                "title": "Cold Chain Monitoring",
                                "desc": "Real-time temperature and humidity monitoring across warehousing and distribution.",
                ...
                },
                {
                                ...
                                "desc": "Real-time quality attribute monitoring enabling in-process control.",
                                "img": "https://images.unsplash.com/photo-1579154204601-01588f351e67?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "30% cycle time cut",
                                "title": "Golden Batch Analytics",
                                "desc": "Recipe optimization comparing every batch against ideal reference profiles.",
                                "img": "https://images.unsplash.com/photo-1581092921461-eab62e97a780?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Serialization",
                                "val": "Full traceability",
                                "title": "Track & Trace",
                                "desc": "End-to-end serialization from unit dose to distribution meeting global mandates.",
                                "img": "https://images.unsplash.com/photo-1628771065518-0d82f1938462?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Digital Twin",
                                "val": "Virtual commissioning",
                                "title": "Bioreactor Digital Twin",
                                "desc": "Simulate and optimize bioreactor performance before scaling to production.",
                                "img": "https://images.unsplash.com/photo-1531747118685-ca8fa6e08806?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Compliance",
                                "val": "Always audit-ready",
                                "title": "Audit Trail Automation",
                                "desc": "Comprehensive electronic audit trails satisfying 21 CFR Part 11 requirements.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Life Sciences operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Batch Release", val: "50% faster", desc: "Batch review-by-exception replacing manual review.", icon: TrendingUp },
                    { title: "Deviations", val: "30% reduction", desc: "Predictive quality preventing production excursions.", icon: Clock },
                    { title: "Data Compliance", val: "100% integrity", desc: "ALCOA+ data integrity across the operation.", icon: Cpu },
                    { title: "Process Optimization", val: "20% yield gain", desc: "Recipe and parameter optimization at scale.", icon: Award },
                    { title: "Quality Excellence", val: "Right first time", desc: "Higher first-pass yield and lower rework.", icon: Zap },
                    { title: "Product Integrity", val: "Cold chain proof", desc: "Continuous cold chain visibility and alerts.", icon: Database },
                    { title: "Regulatory Confidence", val: "Audit ready", desc: "Always inspection-ready with full audit trails.", icon: Settings },
                    { title: "Time to Patient", val: "Faster to market", desc: "Compressed development-to-commercial timelines.", icon: Settings2 }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Life Sciences organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Life Sciences Operations?</span>
            </h2>
