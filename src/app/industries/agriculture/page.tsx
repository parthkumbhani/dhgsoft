          ...
          <Container className="relative z-10 w-full text-left">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-slate-200 max-w-2xl leading-relaxed text-body-md font-semibold">
                Grow yield and improve resource sustainability — with smart soil probes, autonomous equipment tracking, and predictive water irrigation models.
              </p>
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-txt-strong tracking-tight font-black leading-tight">
                    Accelerating Digital Transformation in <span className="text-gradient-brand">Agriculture</span>
                  </h2>
                  <p className="text-body-md text-txt-muted leading-relaxed">
                    Agricultural organizations must optimize crop yields and conserve water under changing climate patterns. Connecting soil moisture probes, weather API models, and autonomous machinery into unified systems drives maximum crop output.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Smart soil probe moisture analytics",
                      "Autonomous tractor and harvest fleet telemetry",
                      "Predictive water irrigation scheduling models",
                      "Drone crop yield visual mapping scans",
                      "Carbon capture and footprint reporting grids"
].map((trend, idx) => (
                ...
                <div className="card glass-card rounded-2xl p-6 bg-mist border border-line">
                  <h5 className="text-txt-strong font-extrabold mb-2">From Seed Planting to Supply Dispatch</h5>
                  <p className="text-body-sm text-txt-muted leading-relaxed">
                    DHGsoft helps precision agriculture leaders deploy smart sensor grids, integrate machinery status, and analyze soil telemetry to optimize fertilizer and water application.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">$18B</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Precision agriculture market value</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">30%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Water resource conservation</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">25%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Crop yield improvement</span>
                  </div>
                  <div className="card bg-mist border border-line rounded-2xl p-6 text-left shadow-sm hover:border-brand transition-colors">
                    <span className="text-3xl font-black text-brand block mb-2">100%</span>
                    <span className="text-xs text-txt-muted font-medium leading-snug">Crop growth lifecycle visibility</span>
                  </div>
                </div>
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Water scarcity", "Fertilizer runoff", "Harvest timing", "Fleet availability"].map((driver, i) => (
                ...
                <div className="card bg-white border border-line rounded-2xl p-6 text-left hover:border-brand/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Soil health tracking", "Irrigation OEE", "Autonomous machinery", "Carbon accounting"].map((priority, i) => (
                      <div key={i} className="flex items-center gap-2 text-body-sm text-txt-muted">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0" />
                        <span>{priority}</span>
                      </div>
          ...
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-txt-strong font-black tracking-tight leading-tight">
                The Challenges Holding <span className="text-gradient-brand">Agriculture Operations Back</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Water Scarcity</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Over-irrigation draining local aquifers and raising utility costs.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Yield Unpredictability</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Unstable soil nutrients and weather causing crop yield drops.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Runoff Penalties</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Over-fertilization leading to local environmental runoff audits.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Tractor Fleet Uptime</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Harvest machinery breakdown during short seasonal windows.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Wide Field Isolation</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of network access across thousands of rural crop acres.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Carbon Mandates</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  CPG buyers demanding verified low-carbon crop footprints.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Pest Excursions</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Delays in spotting crop pest spread leading to crop loss.
                </p>
              </div>
              <div className="card bg-white border border-line rounded-2xl p-6 flex flex-col gap-4 text-left shadow-sm hover:border-brand transition-colors">
                <div className="w-10 h-10 rounded-xl bg-brand/10 text-brand flex items-center justify-center shrink-0">
                ...
                <h5 className="font-extrabold text-txt-strong leading-tight">Supply Logistics</h5>
                <p className="text-body-sm text-txt-muted leading-relaxed">
                  Lack of coordination between harvest yields and silo capacities.
                </p>
              </div>
            </div>
              ...
              {[
                {
                                ...
                                "desc": "Low-power moisture, pH, and nitrogen sensor grids.",
                                "img": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "SCADA",
                                "val": "Zero water waste",
                                "title": "Smart Irrigation Gates",
                                "desc": "Automated valve control synced with weather and soil moisture data.",
                                "img": "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "AI",
                                "val": "25% higher yields",
                                "title": "Predictive Yield Analytics",
                                "desc": "ML models predicting crop harvest weight based on soil logs.",
                                "img": "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Autonomous",
                                "val": "99% harvest uptime",
                                "title": "Tractor Telematics",
                                "desc": "Predictive maintenance and path optimization for harvest machinery.",
                                "img": "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Drone AI",
                                "val": "Early pest alert",
                                "title": "Multispectral Crop Scans",
                                "desc": "Processing drone images to identify early crop disease stress.",
                                "img": "https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Database",
                                "val": "Scope 3 verified",
                                "title": "Carbon Track & Trace",
                                "desc": "Calculating carbon footprints per crop bushel for supply buyers.",
                                "img": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Analytics",
                                "val": "Optimal nitrogen rate",
                                "title": "Fertility Mapping",
                                "desc": "Prescriptive nitrogen fertilizer application maps based on soil scans.",
                                "img": "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=600&q=80"
                },
                {
                                "tag": "Logistics",
                                "val": "No silo delays",
                                "title": "Silo Storage Sync",
                                "desc": "Live tracking of grain moisture levels during silo storage loading.",
        ...
        <Section variant="white" size="default">
          <Container>
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-body-md text-txt-muted max-w-xl mx-auto leading-relaxed">
                DHGsoft solutions deliver quantifiable results across every dimension of your Agriculture operations.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                    { title: "Crop Yields", val: "25% crop gain", desc: "Higher yield per acre with precision input tuning.", icon: TrendingUp },
                    { title: "Water Efficiency", val: "30% water conservation", desc: "Reduction in over-irrigation using smart valves.", icon: Clock },
                    { title: "Fertilizer Savings", val: "15% cost reduction", desc: "Tuning application maps to prevent over-spraying.", icon: Cpu },
                    { title: "Machinery Availability", val: "Zero harvest downtime", desc: "Condition monitoring of seasonal tractors.", icon: Award },
                    { title: "Rural Connectivity", val: "99% rural coverage", desc: "Mesh network linking remote acreage fields.", icon: Zap },
                    { title: "Carbon Accounting", val: "Scope 3 certified", desc: "Verified carbon logs for corporate grain buyers.", icon: Database },
                    { title: "Disease Mitigation", val: "Early response", desc: "Rapid spotting of crop stress areas.", icon: ShieldAlert },
                    { title: "Silo Logistics", val: "Optimized delivery", desc: "Silo capacity management preventing crop loss.", icon: Settings }
              ].map((imp, idx) => {
        ...
        <Section variant="mist" size="default">
          <Container>
            ...
            <div className="text-left space-y-4 mb-16 max-w-4xl">
              ...
              <p className="text-body-md text-txt-muted leading-relaxed">
                DHGsoft combines deep industrial domain expertise with technology excellence to deliver digital transformation that creates lasting competitive advantage for Agriculture organizations worldwide.
              </p>
            </div>
        ...
        <Section variant="ink" size="default" className="relative overflow-hidden text-center bg-slate-950">
          ...
          <div className="w-full relative z-10 space-y-6">
            ...
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-black">
              Ready to Transform Your <span className="text-gradient-brand">Agriculture Operations?</span>
            </h2>
