      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-screen flex items-center pt-24 pb-12 text-left overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-site mx-auto px-gutter md:px-gutter-md">
            ...
            <div className="text-brand-hot text-label-bold uppercase tracking-[0.3em]">Ethics & Compliance</div>
          ...
          <div className="max-w-site mx-auto px-gutter md:px-gutter-md w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
              <div className="lg:col-span-7 text-left order-2 lg:order-1 space-y-6">
                ...
                <h3 className="text-txt-strong mt-2 tracking-tight font-black leading-tight" style={{ fontSize: 'clamp(28px, 3.5vw, 42px)' }}>Organizations require engineering partners who operate with integrity.</h3>
                <p className="text-txt-strong mt-6" style={{ fontSize: "20px", lineHeight: "1.6", fontWeight: 600 }}>As industries continue to embrace digital transformation, organizations require engineering partners who not only deliver innovative technology but also operate with integrity, responsibility, and transparency.</p>
                <p className="text-body-md text-txt-muted mt-5">DHGsoft is committed to maintaining the highest standards of ethical business conduct, regulatory compliance, information security, and professional accountability. We believe long-term partnerships are built through honesty, responsible engineering, and a culture of continuous improvement.</p>
<p className="text-body-md text-txt-muted mt-5">Every employee, partner, and stakeholder is expected to uphold these principles while contributing to the success of our customers and the industries we serve.</p>
              </div>
        ...
        <section className="relative overflow-hidden bg-mist min-h-[85vh] md:min-h-[90vh] flex items-center py-16 md:py-24">
          <div className="max-w-site mx-auto px-gutter md:px-gutter-md w-full">
            <div className="text-center max-w-[720px] mx-auto mb-14">
              <div className="text-brand text-label-bold uppercase tracking-[0.25em]">Our Ethical Principles</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="card bg-white border border-line rounded-[24px] p-8 hover:border-brand hover:shadow-xl hover:-translate-y-1 transition-all text-left flex flex-col justify-start min-h-[220px]">
                ...
                <p className="text-body-md text-txt-muted mt-4 leading-relaxed">We conduct every engagement with honesty, transparency, and accountability. Our commitment to ethical business practices strengthens the trust placed in us by customers, partners, and employees.</p>
              </div>
              ...
              <div className="card bg-white border border-line rounded-[24px] p-8 hover:border-brand hover:shadow-xl hover:-translate-y-1 transition-all text-left flex flex-col justify-start min-h-[220px]">
                ...
                <h4 className="text-txt-strong font-extrabold text-xl leading-snug">Compliance</h4>
                <p className="text-body-md text-txt-muted mt-4 leading-relaxed">We align our operations with industry regulations, engineering standards, contractual obligations, and corporate governance practices to ensure responsible project delivery.</p>
              </div>
              ...
              <div className="card bg-white border border-line rounded-[24px] p-8 hover:border-brand hover:shadow-xl hover:-translate-y-1 transition-all text-left flex flex-col justify-start min-h-[220px]">
                ...
                <h4 className="text-txt-strong font-extrabold text-xl leading-snug">Responsible Engineering</h4>
                <p className="text-body-md text-txt-muted mt-4 leading-relaxed">Every engineering decision considers safety, reliability, scalability, and long-term operational impact. We design solutions that support sustainable industrial growth while maintaining engineering quality and operational integrity.</p>
              </div>
              ...
              <div className="card bg-white border border-line rounded-[24px] p-8 hover:border-brand hover:shadow-xl hover:-translate-y-1 transition-all text-left flex flex-col justify-start min-h-[220px]">
                ...
                <h4 className="text-txt-strong font-extrabold text-xl leading-snug">Transparency</h4>
                <p className="text-body-md text-txt-muted mt-4 leading-relaxed">Open communication builds stronger partnerships. We maintain clear project governance, transparent reporting, measurable deliverables, and collaborative decision-making throughout every customer engagement.</p>
              </div>
        ...
        <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center overflow-hidden py-16 md:py-24">
          ...
          <div className="relative z-10 max-w-site mx-auto px-gutter md:px-gutter-md text-left w-full">
            <div className="max-w-[720px] space-y-6">
              <div className="text-brand-hot text-label-bold uppercase tracking-[0.2em]">Responsible Engineering Posture</div>
              <p className="text-white mt-6 leading-relaxed font-black" style={{ fontSize: 'clamp(24px, 3.5vw, 38px)' }}>Our zero-trust information security guidelines and transparent project delivery frameworks ensure client security and operational safety at all times.</p>
            </div>
          </div>
        </section>
        <div className="w-full h-px bg-line/60" />
        ...
        <section className="relative overflow-hidden bg-mist min-h-[50vh] flex items-center py-14 md:py-20 text-center">
          <div className="max-w-[1000px] mx-auto px-6 md:px-12 w-full">
            ...
            <h3 className="text-txt-strong mt-6 font-black leading-snug" style={{ fontSize: 'clamp(24px, 3.5vw, 38px)' }}>Ethics and compliance are not independent activities. They are integrated into every engineering process, every customer interaction, and every technology solution we deliver.</h3>
          </div>
        </section>
        <div className="w-full h-px bg-line/60" />
