        ...
        <section className="relative overflow-hidden bg-mesh-glow-light bg-dot-matrix min-h-[85vh] md:min-h-[90vh] flex items-center py-16 md:py-24">
          <div className="max-w-site mx-auto px-gutter md:px-gutter-md w-full relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-3.5 max-w-[1000px] mx-auto">
              <span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Industrial Manufacturing</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Automotive</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Semiconductor</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Life Sciences</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Chemical Manufacturing</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Food & Beverage</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Oil & Gas</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Power & Utilities</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Mining & Metals</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Water & Wastewater</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Consumer Packaged Goods</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Data Centres</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">EPC</span><span className="text-body-sm text-txt-strong bg-white border border-line rounded-full px-5 py-2.5 font-semibold hover:border-brand hover:text-brand transition-colors cursor-default select-none shrink-0">Agriculture</span>
            </div>
          </div>
        </section>
        <div className="w-full h-px bg-line/60" />
